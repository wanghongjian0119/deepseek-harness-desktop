...
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  ...
  // The desktop shell publishes the compiled main process; the backend payload
  // (resources/dsh) is assembled by electron-builder, never by npm.
  '@deepseek-ai/dsh-desktop': ['lib/**/*', 'package.json'],
}
